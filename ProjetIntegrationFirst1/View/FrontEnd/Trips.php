...
// Assuming $ListVoyages is an array of associative arrays with keys matching your database schema
$voyageC = new voyageC();
$ListVoyages = $voyageC->getVoyageByEtat2("nonsuprime");
?>
<!DOCTYPE html>
<html lang="en">
   ...
   <!-- <div class="container-fluid bg-dark px-5 d-none d-lg-block">
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <?php
            // Mapping static images to voyages
            $images = ["img/package-1.jpg", "img/package-2.jpg", "img/package-3.jpg"];
            $delays = ["0.1s", "0.3s", "0.5s"];

            foreach ($ListVoyages as $index => $voyage) {
                if ($index >= count($images)) break; // Ensure we do not exceed the number of images

                echo '<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="' . $delays[$index] . '">';
                echo '    <div class="package-item">';
                echo '        <div class="overflow-hidden">';
                echo '            <img class="img-fluid" src="' . $images[$index] . '" alt="">';
                echo '        </div>';
                echo '        <div class="d-flex border-bottom">';
                echo '            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>' . $voyage['titre'] . '</small>';
                echo '            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>' . (new DateTime($voyage['date_fin']))->diff(new DateTime($voyage['date_debut']))->format('%a days') . '</small>';
                echo '            <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>2 Person</small>';
                echo '        </div>';
                echo '        <div class="text-center p-4">';
                echo '            <h3 class="mb-0">$' . number_format($voyage['prix'], 2) . '</h3>';
                echo '            <div class="mb-3">';
                ...
                echo '                <a href="#" class="btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>';
